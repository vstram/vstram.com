...
BLOG_AUTHOR = "vstram"  # (translatable)
BLOG_TITLE = {
    DEFAULT_LANG: "Meu Portfólio & Blog Pessoal", 
    EN: "My Personal Portfolio & Blog"
} 
...
BLOG_EMAIL = "vstram@gmail.com"
BLOG_DESCRIPTION = {
    DEFAULT_LANG: "Este é meu Portfólio & Blog Pessoal.",
    EN: "This is my Personal Portfolio & Blog"
}
...
NAVIGATION_ALT_LINKS = {
    DEFAULT_LANG: ("/pt_br", "Português"),
    EN: ("/en", "English"),
}

# Name of the theme to use. (ATTENTION: CHANGE THIS CAN CAUSE SOME PROBLEMS WITH THE LANGUAGE SETTING!!)
THEME = "bootstrap3" 
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-77110532-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-77110532-1');
</script>
"""
